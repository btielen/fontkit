...
This project is a fork of https://github.com/Hopding/fontkit created for use in https://github.com/Hopding/pdf-lib.

While working with `@pdf-lib/fontkit` in a browser environment, we ran into the 
error `fontkit.create is not a function`. This fork exports and publishes the original
package solely in CommonJS format.

Listed below are changes that have been made in this fork:

- build and publish package as CommonJS on NPM
